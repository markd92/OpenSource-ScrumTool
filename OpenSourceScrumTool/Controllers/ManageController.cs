    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetFullNameSuccess ? "Your name has been updates."
                : "";
            ...
            var model = new IndexViewModel
            {
                ...
                FullName = (await UserManager.FindByIdAsync(userId)).Fullname
            };
            return View(model);
        }
        ...
        //
        // GET: /Manage/SetName
        public async Task<ActionResult> SetName()
        {
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            return View(new SetNameViewModel()
            {
