    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Projects", t => t.Product_ID, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        PBI_ID = c.Int(nullable: false),
                        Title = c.String(nullable: false, maxLength: 255),
                        Description = c.String(),
                        State = c.Int(nullable: false),
                        TimeRemaining = c.Long(nullable: false),
                        Priority = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Features", t => t.PBI_ID, cascadeDelete: true)
                .Index(t => t.PBI_ID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Tasks", "PBI_ID", "dbo.Features");
            ...
            DropIndex("dbo.Tasks", new[] { "PBI_ID" });
